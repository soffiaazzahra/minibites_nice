...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      @include('template.home.navbar') <!-- Pastikan file navbar.blade.php ada di folder template.home -->

      
    </div>
  </header>

  @include('template.home.main') <!-- Pastikan file main.blade.php ada di folder template.home -->

  @include('template.home.footer') <!-- Pastikan file footer.blade.php ada di folder template.home -->
  ...
  <script>
    // Preloader script: hide preloader when page is fully loaded
